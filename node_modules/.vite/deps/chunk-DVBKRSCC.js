...
// node_modules/@usewaypoint/block-html/dist/index.mjs
...
function Html({ style, props }) {
  ...
  if (!children) {
    return import_react.default.createElement("div", { style: cssStyle });
  }
  return import_react.default.createElement("div", { style: cssStyle, dangerouslySetInnerHTML: { __html: children } });
}
...
//# sourceMappingURL=chunk-DVBKRSCC.js.map
